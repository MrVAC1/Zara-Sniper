...
show_menu() {
    ...
    echo "======================================================"
    echo "  1. ПЕРВИННЕ НАЛАШТУВАННЯ / ВІДНОВЛЕННЯ (npm install)"
...
show_instructions() {
    ...
    echo ""
    echo "1. Зайдіть в 'НАЛАШТУВАННЯ' (Пункт 5) та перевірте ваші дані."
    echo ""
    echo "2. ЗАПУСТІТЬ БОТА (Пункт 3)."
    echo ""
    echo "======================================================"
...
while true; do
    ...
    case $choice in
        1) install_bot ;;
        2) cd "$BOT_DIR" && echo "[INFO] Оновлення з GitHub..." && git pull && rm -f package-lock.json && npm install && read -p "Оновлено. Enter..." ;;
